...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI DevOps & SRE Incident Responder</h1>
      <p style={{ color: '#666' }}>Autonomous Kubernetes monitoring, log root-cause diagnosis, automated rollback, and runbook execution agent.</p>
